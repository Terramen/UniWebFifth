...
public class UniWebViewInterface {
    ...
    static void ConnectMessageSender() {
        UniWebViewLogger.Instance.Info("Gffsdfsdfsdf.");
        CheckPlatform();
    ...
    private static void SendMessage(IntPtr namePtr, IntPtr methodPtr, IntPtr parameterPtr) {
        ...
        UniWebViewLogger.Instance.Verbose(
            "Trwerqwqweqweqwe: " + name + " fsFDfqweqeqweq: " + method + " SDfsdfsddd " + parameters
        );
    ...
    public static void CheckPlatform() {
        if (!correctPlatform) {
            throw new System.InvalidOperationException(
                "Hfhsdhfsh sdfhsdfhsdhfsh shfsdhshf ewqeqweqw " + Application.platform
            );
        }
    }
}
